...
public class PantallaRanking extends javax.swing.JFrame {
    ...
    private int Id;
    private ArrayList<String> listaRanking;
    /**
     * Creates new form PantallaRanking
     */
    public PantallaRanking(int Identificador) {
        Id = Identificador;
        listaRanking = CP.listaRanking(Id);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        LabelPartidas.setText("Ranking");

        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = listaRanking.toArray(new String[0]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaRanking.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
